...
export const LEVELS = [
  {
    ...
    boss: { name: 'Litter Imp', variant: 'imp', hits: 1, coreNeed: 3, throwT: [6, 8], dmg: 10, scale: 0.55 },
    tutorial: true,
  ...
  },
  {
    ...
    boss: { name: 'Oil Sludge Beast', variant: 'oil', hits: 2, coreNeed: 4, throwT: [5, 7], dmg: 12, scale: 0.7 },
  ...
  },
  {
    ...
    boss: { name: 'Smog Golem', variant: 'smog', hits: 2, coreNeed: 5, throwT: [4.5, 6.5], dmg: 15, scale: 0.85 },
  ...
  },
  {
    ...
    boss: { name: 'Plastic Kraken', variant: 'kraken', hits: 3, coreNeed: 4, throwT: [4, 5.5], dmg: 18, scale: 0.9 },
  ...
  },
  {
    ...
    boss: { name: 'The Garbage Monster', variant: 'garbage', hits: 3, coreNeed: 4, throwT: [3.5, 5.5], dmg: 20, scale: 1.05 },
